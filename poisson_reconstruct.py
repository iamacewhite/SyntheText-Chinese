...
if __name__=='__main__':
    ...
    im_actual_L = cv2tColor(im_src.astype('uint8'),cv2.CV_BGR2Lab)[:,:,0]
    im_alpha_L = cv2tColor(im_alpha.astype('uint8'),cv2.CV_BGR2Lab)[:,:,0]
    im_poisson_L = cv2tColor(im_res.astype('uint8'),cv2.CV_BGR2Lab)[:,:,0]
